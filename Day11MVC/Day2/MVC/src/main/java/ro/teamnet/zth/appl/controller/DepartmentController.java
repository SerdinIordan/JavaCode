...
import ro.teamnet.zth.appl.service.DeparmentServiceImpl;
...
public class DepartmentController {
    ...
    public Department getOneDepartment(@Z2HRequestParam(name = "departmentId") Long deparmentId) {
        return departmentService.findOneDepartment(deparmentId);
    }
