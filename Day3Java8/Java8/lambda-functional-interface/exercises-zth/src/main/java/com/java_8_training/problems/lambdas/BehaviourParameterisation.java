...
//lista si interfata
    ...
    public static void prettyPrintHeavyLightApple(List<Apple> inventory,Printer applePrinter) {
    ...
    public static void prettyPrintOnlyWeightApple(List<Apple> inventory) {
        ...
        for (Apple a:inventory){
            System.out.println("An Apple of"+ a.getWeight()+"grams");
        }
    }

}
//trebuie sa aiba o metoda la Functional Interface
@FunctionalInterface
interface Printer<T>{
...
class CustomPrinter implements Printer{
    ...
    public void print(Object object) {
        if (object instanceof Apple){
            Apple apple=(Apple) object;   //facem cast
        }
    }
}
