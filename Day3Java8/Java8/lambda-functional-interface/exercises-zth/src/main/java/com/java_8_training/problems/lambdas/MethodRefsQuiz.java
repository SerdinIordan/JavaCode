...
public class MethodRefsQuiz {
    ...
    public void contains(){
        ...
        BiPredicate<List<String>, String> contains = List::contains;   //unde isi cauta clasa la List
    ...
    public void formatText() {
        ...
        Function<String, String> formatText =formatter::format; //clasa sau metoda pe care e definita obiectul
