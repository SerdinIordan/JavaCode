...
<script type="text/javascript">
    function exportFile() {
        ...
        if (username != null && username != "") {
           ...
           // window.open()
            //username variabila noastra
            var fileType='pdf';
            window.open("/servlet-app-day2/export?username="+username+"&fileType="+fileType);
           // window.open()
            ...
            // TIP: Remember that the application context it's named servlet-app
            window.open("/servlet-app-day2/export?fileType="+fileType);
